...
//			System.in.read();
	...
	void lectureExample3() throws Exception {
		String input = """
				image a(string url, int width, int height)
				      ...
				      ^b;
				      """;
		String url = "https://pbs.twimg.com/media/FAJeVDKUUAQwMcB?format=jpg&name=large";
	...
	*/
	...
	@Test
	void testWriteToFile1() throws Exception {
		String input = """
        void f(string url)
           image b <- url;
           image c = getBlue(b);
	...
	@Test
	void testWriteTextToFile2() throws Exception {
		String input = """
        void f()
	...
	@Test
	void imageColorArith() throws Exception {
		String input = """
